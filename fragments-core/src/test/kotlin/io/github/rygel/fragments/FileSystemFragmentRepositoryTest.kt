...
class FileSystemFragmentRepositoryTest {
    ...
    @Test
    fun getAllReturnsEmptyListWhenNoFilesExist() =
        runBlocking {
    ...
    @Test
    fun getAllVisibleExcludesInvisibleFragments() =
        runBlocking {
            createTestFile(
                "visible.md",
                """
    ...
    @Test
    fun getBySlugReturnsCorrectFragment() =
        runBlocking {
            createTestFile(
                "test-post.md",
                """
    ...
    @Test
    fun getBySlugReturnsNullForNonExistentSlug() =
        runBlocking {
    ...
    @Test
    fun parseFrontMatterExtractsAllFieldsCorrectly() =
        runBlocking {
            createTestFile(
                "full-post.md",
                """
    ...
    @Test
    fun getByTagReturnsFragmentsWithMatchingTag() =
        runBlocking {
            createTestFile(
                "kotlin-post.md",
                """
    ...
    @Test
    fun getByCategoryReturnsFragmentsWithMatchingCategory() =
        runBlocking {
            createTestFile(
                "tech-post.md",
                """
    ...
    @Test
    fun previewIsExtractedFromMoreTag() =
        runBlocking {
            createTestFile(
                "with-more.md",
                """
    ...
    @Test
    fun updateFragmentStatusUpdatesFileAndCache() =
        runBlocking {
            createTestFile(
                "draft-post.md",
                """
            ...
            assertTrue(updateResult.isSuccess, "Expected success but got: ${updateResult.exceptionOrNull()}")
    ...
    @Test
    fun getAllVisibleExcludesDraftAndArchived() =
        runBlocking {
            createTestFile(
                "draft.md",
                """
    ...
    @Disabled
    @Test
    fun getAllVisibleIncludesScheduledFragmentsPastPublishDate() =
        runBlocking {
    ...
    @Test
    fun updateFragmentStatusReturnsFailureForNonExistentSlug() =
        runBlocking {
    ...
    @Test
    fun updateFragmentStatusValidatesTransitions() =
        runBlocking {
            createTestFile(
                "test-post.md",
                """
    ...
    @Test
    fun updateFragmentStatusRejectsInvalidTransition() =
        runBlocking {
            createTestFile(
                "archived-post.md",
                """
    ...
    @Test
    fun updateFragmentStatusForcesInvalidTransition() =
        runBlocking {
            createTestFile(
                "archived-post.md",
                """
