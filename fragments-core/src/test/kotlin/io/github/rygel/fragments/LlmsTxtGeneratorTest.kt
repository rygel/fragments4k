...
class LlmsTxtGeneratorTest {
    @Test
    fun generateWithBlogPostsAndPages() =
        runBlocking {
    ...
    @Test
    fun generateWithEmptyRepository() =
        runBlocking {
            val repo = InMemoryFragmentRepository()
    ...
    @Test
    fun previewTextIsTruncatedAt160Characters() =
        runBlocking {
    ...
    @Test
    fun generateStripsTrailingSlashFromSiteUrl() =
        runBlocking {
            val repo = InMemoryFragmentRepository()
            repo.addFragment(
                createFragment(
    ...
    @Test
    fun blogPostsAreSortedByDateDescending() =
        runBlocking {
            val repo = InMemoryFragmentRepository()
            repo.addFragment(
                createFragment(
