...
class WorkflowEnhancementTest {
    ...
    @Test
    fun fragmentHasIsReviewAndIsApprovedProperties() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test",
    ...
    @Test
    fun statusChangeHistoryRecordsTransitions() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test",
    ...
    @Test
    fun statusChangeHistoryAccumulatesTransitions() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test",
    ...
    @Test
    fun getAllVisibleExcludesReviewAndApproved() =
        runBlocking {
            val draft =
                Fragment(
                    title = "Draft",
    ...
    @Test
    fun publishMultipleUpdatesMultipleFragments() =
        runBlocking {
            val draft1 =
                Fragment(
                    title = "Draft 1",
    ...
    @Test
    fun archiveMultipleUpdatesMultipleFragments() =
        runBlocking {
            val published1 =
                Fragment(
                    title = "Published 1",
    ...
    @Test
    fun expiryDateFieldIsParsedAndStored() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test",
    ...
    @Test
    fun getAllVisibleRespectsExpiryDate() =
        runBlocking {
    ...
    @Test
    fun getFragmentsExpiringSoonReturnsCorrectFragments() =
        runBlocking {
            val now = LocalDateTime.now()
    ...
    @Test
    fun statusChangeHistoryRecordsScheduledPublication() =
        runBlocking {
            val now = LocalDateTime.now()
    ...
    @Test
    fun statusChangeHistoryRecordsExpiry() =
        runBlocking {
            val now = LocalDateTime.now()
