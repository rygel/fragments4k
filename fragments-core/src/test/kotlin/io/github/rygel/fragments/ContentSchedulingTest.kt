...
class ScheduledPublicationJobTest {
    ...
    @Test
    fun testExecutePublishesDueFragments() =
        runBlocking {
    ...
    @Test
    fun testExecuteWithCustomThreshold() =
        runBlocking {
    ...
    @Test
    fun testExecuteWithNoDueFragments() =
        runBlocking {
    ...
    @Test
    fun testScheduledPublicationResultCalculations() =
        runBlocking {
            val result =
    ...
    @Test
    fun testScheduledPublicationListenerBeforePublications() =
        runBlocking {
            var beforeCalled = false
            var fragmentsBefore: List<Fragment>? = null

            val listener =
                object : ScheduledPublicationListener {
                    ...
                    override suspend fun onPublicationError(
                        fragment: Fragment,
                        error: Throwable,
                    ) {}
                }
    ...
    @Test
    fun testScheduledPublicationListenerAfterPublications() =
        runBlocking {
    ...
    @Test
    fun testGetScheduledFragmentsDueForPublication() =
        runBlocking {
    ...
    @Test
    fun testPublishScheduledFragments() =
        runBlocking {
...
class ContentSchedulingTest {
    ...
    @Test
    fun testScheduleMultipleFragments() =
        runBlocking {
    ...
    @Test
    fun testScheduleMultipleWithPartialFailure() =
        runBlocking {
            val publishDate = now.plusDays(1)
            val results =
                repository.scheduleMultiple(
    ...
    @Test
    fun testScheduleMultipleWithEmptyList() =
        runBlocking {
            val publishDate = now.plusDays(1)
            val results =
                repository.scheduleMultiple(
    ...
    @Test
    fun testScheduleMultipleWithSamePublishDate() =
        runBlocking {
    ...
    @Test
    fun testGetAllScheduledFragments() =
        runBlocking {
            val publishDate = now.plusDays(1)
            repository.scheduleMultiple(
...
class PublicationNotificationServiceTest {
    ...
    @Test
    fun testNoOpNotificationServiceDoesNothing() =
        runBlocking {
    ...
    @Test
    fun testLoggingNotificationServiceCreatesNotifications() =
        runBlocking {
            val notifications = mutableListOf<PublicationNotification>()
            val listener =
                object : PublicationNotificationListener {
