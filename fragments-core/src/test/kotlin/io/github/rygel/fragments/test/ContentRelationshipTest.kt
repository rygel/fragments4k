...
class ContentRelationshipTest {
    @Test
    fun testPreviousNextPostsByDate() =
        runBlocking {
    ...
    @Test
    fun testRelatedByContentReferences() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
            ...
            val fragment1 =
                Fragment(
                    ...
                    publishDate = null,
                    preview = "Content",
                    htmlContent = "This is the main post. See also {{fragment:post-2}} and {{fragment:post-3}}",
                    frontMatter = emptyMap(),
                    visible = true,
                    template = "blog",
                    status = FragmentStatus.PUBLISHED,
    ...
    @Test
    fun testNoRelationshipsWhenNoMatches() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
    ...
    @Test
    fun testContentRelationshipsViewModelIntegration() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
    ...
    @Test
    fun testExcludeCurrentFromRelated() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
    ...
    @Test
    fun testRelationshipConfigLimits() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
    ...
    @Test
    fun testEmptyContentReferences() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
            ...
            val fragment =
                Fragment(
                    ...
                    publishDate = null,
                    preview = "Content",
                    htmlContent = "This is a simple post with no content references.",
                    frontMatter = emptyMap(),
                    visible = true,
                    template = "blog",
                    status = FragmentStatus.PUBLISHED,
