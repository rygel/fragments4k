...
class FragmentAuthorFilteringTest {
    ...
    @Test
    fun testGetByLegacyAuthorField() =
        runBlocking {
            val repository = InMemoryFragmentRepository()
    ...
    @Test
    fun testPrimaryAuthorReturnsFirstAuthorId() =
        runBlocking {
            val fragment =
                Fragment(
                    slug = "test-post",
    ...
    @Test
    fun testPrimaryAuthorFallsBackToLegacyAuthor() =
        runBlocking {
            val fragment =
                Fragment(
                    slug = "test-post",
    ...
    @Test
    fun testPrimaryAuthorReturnsNullWhenNoAuthors() =
        runBlocking {
            val fragment =
                Fragment(
                    slug = "test-post",
