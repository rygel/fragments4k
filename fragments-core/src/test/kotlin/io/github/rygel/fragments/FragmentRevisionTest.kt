...
class FragmentRevisionTest {
    ...
    @Test
    fun fragmentRevisionHasCorrectProperties() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun saveRevisionIncrementsVersion() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun getRevisionsReturnsAllRevisionsForFragment() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun getRevisionByIdReturnsCorrectRevision() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun getLatestRevisionReturnsMostRecent() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun getRevisionAtVersionReturnsCorrectVersion() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun revertToRevisionCreatesCorrectFragment() =
        runBlocking {
            val fragment =
                Fragment(
    ...
    @Test
    fun revertToRevisionFailsForInvalidId() =
        runBlocking {
    ...
    @Test
    fun deleteRevisionsRemovesAllRevisions() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun getRevisionCountReturnsCorrectCount() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun getAllRevisionSlugsReturnsAllSlugs() =
        runBlocking {
            val fragment1 =
                Fragment(
    ...
    @Test
    fun deleteRevisionsBeforeRemovesOldRevisions() =
        runBlocking {
    ...
    @Test
    fun repositoryCreateRevisionWorks() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun repositoryGetFragmentRevisionsWorks() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
    ...
    @Test
    fun repositoryRevertToRevisionWorks() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Original Title",
    ...
    @Test
    fun revisionRepositoryClearResetsState() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test Fragment",
