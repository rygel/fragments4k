...
class ContentExpiryTest {
    ...
    @Test
    fun testFragmentExpiryDateProperty() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Test",
    ...
    @Test
    fun testGetAllVisibleExcludesExpiredFragments() =
        runBlocking {
            val expiredFragment =
                Fragment(
                    title = "Expired Post",
    ...
    @Test
    fun testGetFragmentsExpiringSoon() =
        runBlocking {
    ...
    @Test
    fun testExpireFragmentsTransitionsToExpiredStatus() =
        runBlocking {
            val fragment =
                Fragment(
                    title = "Old Post",
    ...
    @Test
    fun testExpireFragmentsDoesNotAffectNewContent() =
        runBlocking {
            val newFragment =
                Fragment(
                    title = "New Post",
    ...
    @Test
    fun testUnpublishMultipleTransitionsToDraft() =
        runBlocking {
            val fragment1 =
                Fragment(
                    title = "Post 1",
    ...
    @Test
    fun testUnpublishMultipleWithPartialFailure() =
        runBlocking {
            val fragment1 =
                Fragment(
                    title = "Post 1",
    ...
    @Test
    fun testExpiredFragmentsAreNotVisible() =
        runBlocking {
            val expiredFragment =
                Fragment(
                    title = "Expired",
    ...
    @Test
    fun testDraftFragmentsAreNotVisible() =
        runBlocking {
            val draftFragment =
                Fragment(
                    title = "Draft",
    ...
    @Test
    fun testGetFragmentsExpiringSoonWithDefaultThreshold() =
        runBlocking {
            val expiringIn5Days =
                Fragment(
    ...
    @Test
    fun testGetFragmentsExpiringSoonOnlyPublished() =
        runBlocking {
            val draftExpiring =
                Fragment(
