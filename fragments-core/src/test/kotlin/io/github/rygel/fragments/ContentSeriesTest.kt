...
class ContentSeriesTest {
    ...
    @Test
    fun testGetActiveSeriesOnlyActive() =
        runBlocking {
    ...
    @Test
    fun testSeriesNavigationFirstPart() =
        runBlocking {
            val series =
                ContentSeries(
    ...
    @Test
    fun testSeriesNavigationLastPart() =
        runBlocking {
            val series =
                ContentSeries(
    ...
    @Test
    fun testGetPreviousPartInSeries() =
        runBlocking {
            val series =
                ContentSeries(
    ...
    @Test
    fun testGetPreviousPartInSeriesFirstPart() =
        runBlocking {
            val series =
                ContentSeries(
