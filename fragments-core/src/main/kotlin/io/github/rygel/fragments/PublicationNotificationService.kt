...
interface PublicationNotificationService {
    suspend fun notifyScheduledPublication(
        fragment: Fragment,
        scheduledDate: LocalDateTime,
    )

    suspend fun notifyPublicationReminder(
        fragment: Fragment,
        hoursBefore: Int,
    )
    ...
    suspend fun notifyPublicationFailure(
        fragment: Fragment,
        error: Throwable,
    )
}
...
class NoOpPublicationNotificationService : PublicationNotificationService {
    override suspend fun notifyScheduledPublication(
        fragment: Fragment,
        scheduledDate: LocalDateTime,
    ) {
    }

    override suspend fun notifyPublicationReminder(
        fragment: Fragment,
        hoursBefore: Int,
    ) {
    }
    ...
    override suspend fun notifyPublicationFailure(
        fragment: Fragment,
        error: Throwable,
    ) {
    }
