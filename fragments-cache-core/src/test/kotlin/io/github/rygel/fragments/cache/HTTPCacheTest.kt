...
class HTTPResponseCacheTest {
    ...
    @Test
    fun putAndGetReturnsCachedResponse() =
        runBlocking {
            val headers =
                HTTPCacheHeaders.public(
                    eTag = "\"abc123\"",
            ...
            val response =
                HTTPResponseCache.CachedResponse(
                    body = "Hello, World!",
                    headers = headers,
                )
    ...
    @Test
    fun invalidateRemovesCachedResponse() =
        runBlocking {
            val headers =
                HTTPCacheHeaders.public(
                    eTag = "\"abc123\"",
