...
class InMemoryCacheTest {
    ...
    @Test
    fun invalidateAllRemovesMultipleKeys() =
        runBlocking {
    ...
    @Test
    fun getOrComputeReturnsCachedValue() =
        runBlocking {
    ...
    @Test
    fun getOrComputeComputesAndCaches() =
        runBlocking {
            var computeCalls = 0
            val result1 =
                cache.getOrCompute("key1") {
    ...
    @Test
    fun getStatisticsTracksHitsAndMisses() =
        runBlocking {
            cache.put("key1", "value1")
    ...
    @Test
    fun getStatisticsTracksEvictions() =
        runBlocking {
            val smallCache =
