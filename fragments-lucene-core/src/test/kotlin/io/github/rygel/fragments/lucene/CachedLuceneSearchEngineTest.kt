...
class CachedLuceneSearchEngineTest {
    ...
    @Test
    fun searchWithOptionsCachesResults() =
        runBlocking {
    ...
    @Test
    fun searchByCategoryCachesResults() =
        runBlocking {
    ...
    @Test
    fun getSuggestionsCachesResults() =
        runBlocking {
            val suggestions =
                listOf(
                    SearchSuggestion("Kotlin Programming", 5, SearchSuggestion.SuggestionType.TITLE),
    ...
    @Test
    fun searchUsesDifferentCacheKeysForDifferentQueries() =
        runBlocking {
    ...
    @Test
    fun searchWithOptionsUsesDifferentCacheKeys() =
        runBlocking {
    ...
    @Test
    fun invalidateSearchCacheClearsAllSearchResults() =
        runBlocking {
            val fragment = createTestFragment("slug1")
