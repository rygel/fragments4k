...
class CachedLuceneSearchEngine(
     ...
     */
    private fun generateTagSearchCacheKey(tag: String): String = "tag:${hashString(tag)}"

    /**
     * Generate cache key for category searches
     */
    private fun generateCategorySearchCacheKey(category: String): String = "category:${hashString(category)}"

    /**
     * Generate cache key for suggestions
     */
    private fun generateSuggestionCacheKey(
        query: String,
        limit: Int,
    ): String = "suggestion:${hashString("$query:$limit")}"
