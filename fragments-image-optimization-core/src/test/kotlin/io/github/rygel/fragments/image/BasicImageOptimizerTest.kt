...
class BasicImageOptimizerTest {
    ...
    @Test
    fun optimizeCreatesOptimizedImage() =
        runBlocking {
    ...
    @Test
    fun getMetadataReturnsCorrectInfo() =
        runBlocking {
            val testImage = createTestImage(800, 600)
            val imagePath = testImage.absolutePath
    ...
    @Test
    fun generateResponsiveVariantsCreatesMultipleSizes() =
        runBlocking {
    ...
    @Test
    fun qualityParameterAffectsSize() =
        runBlocking {
            val testImage = createTestImage(800, 600)
            ...
            assertTrue(
                lowQuality.optimizedSize <= highQuality.optimizedSize,
    ...
    @Test
    fun optimizeReturnsErrorForInvalidInput() =
        runBlocking {
    ...
    @Test
    fun generateMediaQueryForDifferentWidths() =
        runBlocking {
            val width = 480
    ...
    private fun createComplexImageData(
        width: Int,
        height: Int,
    ): ByteArray {
        val image = BufferedImage(width, height, BufferedImage.TYPE_INT_RGB)
